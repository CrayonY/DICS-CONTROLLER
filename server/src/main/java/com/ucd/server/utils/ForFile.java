...
public class ForFile {
    ...
    //private static String path = "/Users/crayon/Desktop/";
    ...
    public static boolean TDHcreate(String fileName, String guardianAccessToken) {
        ...
        // 大漾田 A中心
        // String url = "http://10.50.197.11:14000/webhdfs/v1/tmp/"+fileName+"?op=CREATE&data=TRUE&user.name=hdfs";
        // 控制中心 B中心
        String url = "http://10.50.198.11:14000/webhdfs/v1/tmp/" + fileName + "?op=CREATE&data=TRUE&user.name=hdfs";
    ...
    public static boolean TDHdelete(String fileName, String guardianAccessToken) {
        ...
        //String url = "http://10.50.197.11:14000/webhdfs/v1/tmp/"+fileName+"?op=DELETE&user.name=hdfs";
        // 控制中心 B中心
        String url = "http://10.50.198.11:14000/webhdfs/v1/tmp/" + fileName + "?op=DELETE&user.name=hdfs";
